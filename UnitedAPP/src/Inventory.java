...
public class Inventory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButton3.setText("Shipping");
        ...
        jRadioButton6.setText("Genomics");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Connection DBConn1 = null;       // MySQL connection handle
        ...
        if ( !fieldError )
        {
            try
            {
                ...
                msgString = ">> Establishing connection with: " + sourceURL1 + " and " + sourceURL2 + "...";
                jTextArea1.append("\n"+msgString);
